...
abstract class AppLocalizations {
  ...
  /// No description provided for @facesTitle.
  ///
  /// In en, this message translates to:
  /// **'Faces'**
  String get facesTitle;

  /// No description provided for @fingerprintsTitle.
  ///
  /// In en, this message translates to:
  /// **'Fingerprints'**
  String get fingerprintsTitle;
  ...
  /// No description provided for @clearAllFacesTitle.
  ///
  /// In en, this message translates to:
  /// **'Clear All Faces'**
  String get clearAllFacesTitle;

  /// No description provided for @clearAllFacesConfirm.
  ///
  /// In en, this message translates to:
  /// **'Are you sure you want to clear all faces?'**
  String get clearAllFacesConfirm;

  /// No description provided for @clearAllFingerprintsTitle.
  ///
  /// In en, this message translates to:
  /// **'Clear All Fingerprints'**
  String get clearAllFingerprintsTitle;

  /// No description provided for @clearAllFingerprintsConfirm.
  ///
  /// In en, this message translates to:
  /// **'Are you sure you want to clear all fingerprints?'**
  String get clearAllFingerprintsConfirm;

  /// No description provided for @addFaceTitle.
  ///
  /// In en, this message translates to:
  /// **'Add Face'**
  String get addFaceTitle;
  ...
  /// No description provided for @faceFeatureDataSuccess.
  ///
  /// In en, this message translates to:
  /// **'Face feature data obtained successfully.'**
  String get faceFeatureDataSuccess;

  /// No description provided for @faceFeatureDataFailed.
  ///
  /// In en, this message translates to:
  /// **'Failed to get feature data: {error}'**
  String faceFeatureDataFailed(Object error);

  /// No description provided for @faceAddedSuccessfully.
  ///
  /// In en, this message translates to:
  /// **'Face added successfully.'**
  String get faceAddedSuccessfully;

  /// No description provided for @faceAddFailed.
  ///
  /// In en, this message translates to:
  /// **'Failed to add face: {error}'**
  String faceAddFailed(Object error);

  /// No description provided for @faceSelectImageFirst.
  ///
  /// In en, this message translates to:
  ...
  ///
  /// In en, this message translates to:
  /// **'Locks for {gatewayName}'**
  String locksForGateway(Object gatewayName);

  /// No description provided for @tc2Scanning.
  ///
  /// In en, this message translates to:
  /// **'TC2 scanning...'**
  String get tc2Scanning;

  /// No description provided for @db2Scanning.
  ///
  /// In en, this message translates to:
  /// **'DB2 scanning...'**
  String get db2Scanning;

  /// No description provided for @sensorScanning.
  ///
  /// In en, this message translates to:
  /// **'Sensor scanning...'**
  String get sensorScanning;

  /// No description provided for @electricMeterScanning.
  ///
  /// In en, this message translates to:
  /// **'Electric meter scanning...'**
  String get electricMeterScanning;

  /// No description provided for @waterMeterScanning.
  ///
  /// In en, this message translates to:
  /// **'Water meter scanning...'**
  String get waterMeterScanning;

  /// No description provided for @bluetoothFailed.
  ///
  /// In en, this message translates to:
  /// **'Failed via Bluetooth: {btError}\n\nFailed via Gateway: {gwError}'**
  String bluetoothFailed(Object btError, Object gwError);

  /// No description provided for @bluetoothTimeout.
  ///
  /// In en, this message translates to:

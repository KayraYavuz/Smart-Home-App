...
class RecurringPeriodPage extends StatefulWidget {
  final Function(DateTime startDate, DateTime endDate, List<int> days,
      TimeOfDay startTime, TimeOfDay endTime) onSave;
          ...
          children: [
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                onPressed: () {
                  widget.onSave(_startDate, _endDate, _selectedDays.toList(),
                      _startTime, _endTime);
                  Navigator.pop(context);
                },
                style: ElevatedButton.styleFrom(
                  backgroundColor:
                      const Color(0xFF2C2C2C), // Gray button per request
